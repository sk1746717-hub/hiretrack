...
const SearchFilterBar = ({
  ...
  return (
    <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-xl backdrop-blur-sm shadow-sm space-y-4 mb-6 w-full relative z-30">
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <select
            ...
            className="w-full md:w-44 px-3 py-2.5 rounded-lg bg-slate-950 border border-slate-800 text-sm text-slate-355 focus:outline-none focus:border-blue-500 cursor-pointer"
