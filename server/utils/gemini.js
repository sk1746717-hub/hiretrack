...
Do not include any extra text or markdown formatting. Return only the raw JSON matching the JSON Schema.
...
`;
  ...
  try {
    ...
    const text = cleanJsonString(response.choices[0].message.content);
